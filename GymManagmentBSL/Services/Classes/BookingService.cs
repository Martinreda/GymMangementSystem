...
using GymManagmentBSL.ViewModels.BookingViewModel;
...
namespace GymManagmentBSL.Services.Classes
{
        ...
        public class BookingService : IBookingService
        {
            ...
            public IEnumerable<SessionViewModel> GetAllSessionsWithTrainerAndCategory()
            {
                ...
                var sessions = sessionRepo.GetAllSessionsWithTrianerAndCategory();
                ...
                foreach (var sessionVm in sessionsVm)
                    sessionVm.AvailableSlots = sessionRepo.GetCountOfBooksSlots(sessionVm.Id);
            ...
            public bool CreateBooking(CreateBookingViewModel createBookingViewModel)
            {
                try
                {
                    ...
                    var sessionRepo = _unitOfWork.SessionRepository;
                    var bookedSlots = sessionRepo.GetCountOfBooksSlots(createBookingViewModel.SessionId);
